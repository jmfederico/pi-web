...
export const chatStyles = css`
  ...
  .go-to-bottom { position: absolute; bottom: 64px; right: 16px; z-index: 21; display: grid; place-items: center; width: 44px; height: 44px; padding: 0; border: 1px solid var(--pi-border); border-radius: 50%; background: var(--pi-bg-overlay); color: var(--pi-text); cursor: pointer; box-shadow: 0 4px 16px var(--pi-shadow); }
  .go-to-bottom svg { width: 20px; height: 20px; fill: none; stroke: currentColor; stroke-width: 2; stroke-linecap: round; stroke-linejoin: round; pointer-events: none; }
  .go-to-bottom:hover { border-color: var(--pi-accent); }
  .go-to-bottom:focus-visible { outline: 2px solid var(--pi-accent); outline-offset: 2px; }
