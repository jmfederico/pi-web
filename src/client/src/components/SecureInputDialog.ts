...
// Dialog shell styles, kept local to this component (the shared picker styles
// this used to reuse were removed when dialogs moved to per-component shells).
const secureInputShellStyles = css`
...
export class SecureInputDialog extends LitElement {
  ...
  static override styles = [secureInputShellStyles, css`
